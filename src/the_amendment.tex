...
\begin{document}
    ...
    \end{enumerate}
    \namedsection{4}{Allocation of Electors to candidates}
    \begin{enumerate}
        ...
        \end{enumerate}
    \end{enumerate}
    \namedsection{5}{Allocation of Electors to Lists}
    \begin{enumerate}
        ...
        \end{enumerate}
    \end{enumerate}
    \namedsection{6}{Selection of Elector Candidates}
    \begin{enumerate}
    ...
    \end{enumerate}
    \namedsection{8}{To provide an alternate method of choosing electors}
    \begin{enumerate}   
