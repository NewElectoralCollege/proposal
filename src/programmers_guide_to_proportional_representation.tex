...
\begin{document}
    ...
    \lstinputlisting[language=Python]{../lib/programming_examples/python.py}

    \section{C++}

    \lstinputlisting[language=C++]{../lib/programming_examples/c++.cpp}

    \section{Purely Functional}

    Haskell is among the most widely used Purely Functional languages.

    \lstinputlisting[language=Haskell]{../lib/programming_examples/Lrm.hs}
    ...
    \lstinputlisting[language=Haskell]{../lib/programming_examples/LrmQuotas.hs}
    ...
    \lstinputlisting[language=C++]{../lib/programming_examples/ham1.cpp}
    ...
    \lstinputlisting[language=C++]{../lib/programming_examples/ham2.cpp}
    ...
    \lstinputlisting[language=Haskell]{../lib/programming_examples/Gallagher.hs}
